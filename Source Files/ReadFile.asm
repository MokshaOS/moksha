...
cprintf() "Read File ( Moksha Operating System File Reading Utility )",59,10,1,012
...
printf() ""
printf() ""     
cprintf() "Your File Data :-",18,0,11,009 
printf() ""                              
printf() ""
     
lea si,File_buffer                                ; Load File_bufefr into si register for printing on the screen through Video BIOS
